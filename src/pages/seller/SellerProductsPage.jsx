...
const EMPTY_FORM = {
  ...
  thumbnailUrl: "",
  categoryId: "",
  optionList: [{ optionName: "", optionValue: "", additionalPrice: "", stockQuantity: "" }],
  productImageList: [],
}
                  ...
                  {formData.optionList.map((opt, idx) => (
                    <div key={idx} className={styles.optionRow}>
                      <input type="number" className={styles.formInput}
                        ...
                        onChange={(e) => handleOptionChange(idx, "additionalPrice", e.target.value)}
                        min="0"
                      />
                      <input type="number" className={styles.formInput}
                        placeholder="재고 (개)"
                        value={opt.stockQuantity}
                        onChange={(e) => handleOptionChange(idx, "stockQuantity", e.target.value)}
                        min="0"
                      />
                      <input type="number" className={styles.formInput}
                        placeholder="추가금액 (원)"
